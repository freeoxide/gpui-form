...
- `#[fluent_kv(keys = ["label", "description"], keys_this)]` to source
  `variant_label()`, type labels, and type descriptions from `es-fluent`
  metadata generated by `EsFluentVariants` / `EsFluentThis`

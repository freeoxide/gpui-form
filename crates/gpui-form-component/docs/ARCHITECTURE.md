...
2. Generated form code wraps variants in `InfiniteSelectItem` for display.
3. UI changes mutate an `InfiniteSelectPath`, which can be turned back into a value via `build_from_path`.

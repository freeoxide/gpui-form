...
impl LocationFormForm {
    ...
    fn on_location_master_select_event(
        ...
        this: &Entity<
            SelectState<
                Vec<
                    gpui_form::gpui_form_component::infinite_select::InfiniteSelectItem<
                        Country,
                    >,
                >,
            >,
    ...
    fn new(window: &mut Window, cx: &mut Context<Self>) -> Self {
            ...
            .new(|cx| {
                let items: Vec<
                    gpui_form::gpui_form_component::infinite_select::InfiniteSelectItem<
                        Country,
                    >,
                > = gpui_form::gpui_form_component::infinite_select::to_select_items::<
                    Country,
                >();
        ...
        let mut location_path = gpui_form::gpui_form_component::infinite_select::InfiniteSelectPath::new();
        ...
        Self {
            ...
            fields: LocationFormFormFields {
                ...
                location_child_selects,
                location_path: gpui_form::gpui_form_component::infinite_select::InfiniteSelectPath::new(),
            },
